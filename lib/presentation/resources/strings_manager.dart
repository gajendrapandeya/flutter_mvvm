class AppStrings {
  ...
  static const String onBoardingSubTitle1 =
      'Tutify is awesome flutter application using clean architecture #1';
  static const String onBoardingSubTitle2 =
      'Tutify is awesome flutter application using clean architecture #2';
  static const String onBoardingSubTitle3 =
      'Tutify is awesome flutter application using clean architecture #3';
  static const String onBoardingSubTitle4 =
      'Tutify is awesome flutter application using clean architecture #4';
